            ...
            VStack {
                ...
                Button("Execute") { buttonPressed = true }
                    ...
                    NavigationLink("", destination:
                                    PostingListExecution (accounts: $accounts, postings: $postings, dateFrom: $dateFrom, dateTo: $dateTo, accountDebit: $accountDebit, accountCredit: $accountCredit, description: $description, amountFrom: $amountFrom, amountTo: $amountTo),
