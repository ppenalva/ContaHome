...
struct BudgetEditPrint: View {
    ...
    var body: some View {
        VStack {
            HStack {
                Text(budget.date, formatter: BudgetEditPrint.taskDateFormat)
...
struct BudgetEditPrint_Previews: PreviewProvider {
